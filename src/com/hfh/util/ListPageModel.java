...
public class ListPageModel {
	...
	public void startAndEndNum(int start,int end, int totalPage,int curPage){
		int forwardNum = end-1;
		int maxShowNum = totalPages<10?totalPages:10;
		int backNum =start+1;
		int step = 2;
		//if(forwardNum==8888888) 
			
		if(page ==forwardNum){
			endPageNum+=step;
			if(endPageNum>totalPages){
				endPageNum = totalPages;
				startPageNum += totalPage - forwardNum-1;
				forwardNum = 8888888;
			}else{
				startPageNum+= step;
				endPageNum +=step;
		...
		if(page==backNum){
			startPageNum-= step;
		      if(startPageNum<=0){
		    	  start = 1;
		    	  endPageNum -= (backNum-1) - startPageNum;
		        backNum = 88888888;
		      }else{
		        backNum -=step;
		        endPageNum-=step;
		...
		System.out.println("start = "+startPageNum);
		System.out.println("end = "+endPageNum);
